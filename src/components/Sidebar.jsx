...
const Sidebar = ({ activeTab, setActiveTab }) => {
    ...
    // Tüm modüller herkese açıktır; yetkiler yalnızca ekleme/düzenleme/silme
    // gibi işlemleri kısıtlar (bkz. utils/permissionCatalog).
    // Tek istisna: Ayarlar bölümü sistem yönetimi yetkisi ister.
    const menuItems = [
