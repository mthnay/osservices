                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-scale-up">
                            <div className="gsx-card p-6">
                                ...
                                <div ref={productPickerRef} className="mb-10 space-y-2 relative">
                                    <p id="sa-product-label" className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">
                                    ...
                                    <button
                                        ...
                                        className={`w-full p-4 rounded-lg border flex items-center justify-between gap-4 text-left transition-all outline-none focus-visible:ring-4 focus-visible:ring-[#0071e3]/25 ${showProductPicker
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            size={18}
                                            aria-hidden="true"
                                            className={`text-gray-400 shrink-0 transition-transform ${showProductPicker ? 'rotate-180' : ''}`}
                                        />
                                    </button>
                                    ...
                                    {showProductPicker && (
                                        <ul
                                            ...
                                            className="absolute top-full left-0 right-0 mt-2 z-40 list-none p-2 m-0 bg-white border border-gray-200 rounded-lg shadow-[0_12px_40px_rgba(0,0,0,0.12)] max-h-80 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-top-2"
                                        >
                                                ...
                                                return (
                                                    <li key={group.id} role="option" aria-selected={selected}>
                                                        <button
                                                            ...
                                                            className={`w-full flex items-center gap-4 p-3 rounded-md text-left transition-colors outline-none focus-visible:ring-4 focus-visible:ring-[#0071e3]/25 ${selected ? 'bg-[#0071e3]/8' : 'hover:bg-gray-50'}`}
                                                        >
                                                            <span className={`w-10 h-10 rounded-md flex items-center justify-center text-white shadow-sm shrink-0 ${group.color}`}>
                                                                <group.icon size={20} />
                                                            </span>
                                                            <span className={`text-sm font-bold truncate ${selected ? 'text-[#0071e3]' : 'text-gray-900'}`}>
                                                                {group.label}
                                                            </span>
