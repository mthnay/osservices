                            ...
                            <div className={CARD}>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="group relative">
                                        <label className={LABEL}>Seri Numarası (S/N) <span className="text-[#e30000]" aria-hidden="true">*</span></label>
                                        <div className="relative">
                                            <input
                                                type="text"
                                                placeholder="Örn: C7H..."
                                    ...
                                    <div className="group relative" ref={suggestionsRef}>
                                        <label className={LABEL}>Cihaz Modeli <span className="text-[#e30000]" aria-hidden="true">*</span></label>
                                        <div className="relative">
                                            <input
                                                type="text"
                                                ...
                                                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-md shadow-2xl border border-gray-100 max-h-64 overflow-y-auto z-50 animate-in fade-in slide-in-from-top-2 custom-scrollbar">
                                                    ...
                                                    <div className="p-1.5">
                                                        {deviceSuggestions.map((suggestion, index) => (
                                                            <button key={index} onClick={() => { setFormData(prev => ({ ...prev, deviceModel: suggestion, serviceType: /iPad|AirPods|Watch|Pencil|Mouse|Trackpad/.test(suggestion) ? 'exchange' : 'repair' })); setShowSuggestions(false); }} className="w-full text-left px-3 py-2 rounded-md hover:bg-blue-50 hover:text-blue-700 transition-colors flex items-center gap-3 group/item border border-transparent hover:border-blue-100">
                                                                <div className="w-7 h-7 rounded-lg bg-gray-100 group-hover/item:bg-white flex items-center justify-center text-gray-500 transition-colors">{suggestion.includes('iPhone') ? <Phone size={14} /> : <Package size={14} />}</div>
                                                                <span className="font-bold text-[13px] text-gray-700 group-hover/item:text-blue-700">{suggestion}</span>
                                                            </button>
                                                        ))}
                                                    </div>
                                                </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                                            <label className={LABEL}>IMEI 1 (Ops.)</label>
                                            <input
                                                type="text"
                                                maxLength="15"
                                                placeholder="35..."
                                        ...
                                        <div>
                                            <label className={LABEL}>IMEI 2 (Ops.)</label>
                                            <input
                                                type="text"
                                                maxLength="15"
                                                placeholder="35..."
