...
import { Clock, CheckCircle, Activity, TrendingUp, PieChart, ArrowUpRight, ArrowDownRight, MoreHorizontal, Wallet, Users, Zap, LayoutDashboard, Store, X, ChevronRight, ShieldAlert, Wrench, PlusCircle, RefreshCw, Trash2, ArrowLeftRight } from 'lucide-react';
...
const Dashboard = () => {
    ...
    // Tüm mağazaları görebilen roller: Mağaza Hareketleri'nde mağaza kolonu bunlara gösterilir.
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="gsx-card overflow-hidden flex flex-col">
                        <div className="px-6 py-5 border-b border-gray-50 flex justify-between items-center bg-white">
                            <div>
                                ...
                                <p className="text-[11px] text-gray-400 font-medium mt-0.5">
                                    {canViewAllStores ? 'Tüm mağazalarda son eklenen, çıkarılan ve güncellenen veriler' : 'Mağazanızda son eklenen, çıkarılan ve güncellenen veriler'}
                                </p>
                            </div>
                        ...
                        <div className="overflow-auto max-h-[520px] custom-scrollbar">
                            <StoreActivityFeed activities={storeActivities} showStore={canViewAllStores} />
                        </div>
                    </div>
                </div>
